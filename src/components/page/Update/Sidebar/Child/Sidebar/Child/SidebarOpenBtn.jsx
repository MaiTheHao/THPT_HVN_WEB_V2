...
const SidebarOpenBtn = () => {
	const { sidebarVisible, proviAction } = useUpdateContext();
	...
	return (
		<animated.button style={styles} onClick={() => proviAction("setSidebarVisible")} className="openBtn sidebarActionBtn">
